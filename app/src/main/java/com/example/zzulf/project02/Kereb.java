...
public class Kereb extends AppCompatActivity {
    ...
    void CheckBoxGetter(){
        ...
        Log.d("Hasil","Kereb Dipilih :"+ opt1 + ", "+opt2 + ", "+opt3 + ", "+opt4 +  ". ");

    }
    void PushData(){
        SharedPreferences Kereb = this.getSharedPreferences("Kereb",MODE_PRIVATE);
        final SharedPreferences.Editor Editor = Kereb.edit();
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cbx_opt1.isChecked() || cbx_opt2.isChecked() || cbx_opt3.isChecked() || cbx_opt4.isChecked() || cbx_opt5.isChecked() || cbx_opt6.isChecked() || cbx_opt7.isChecked() || cbx_opt8.isChecked()  ){
                    ...
                    Toast.makeText(Kereb.this,"Belum ada data yang dipilih",Toast.LENGTH_LONG);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kereb);
    ...
    public void goHome(View view){
        startActivity(new Intent(Kereb.this, InputDataJalan.class));
    }
}
