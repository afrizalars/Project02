...
public class KekerasanPermukaan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kekerasan_permukaan2);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(KekerasanPermukaan2.this, KekerasanPermukaan1.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(KekerasanPermukaan2.this, KekerasanPermukaan3.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(KekerasanPermukaan2.this, InputDataJalan.class));
    }
}
