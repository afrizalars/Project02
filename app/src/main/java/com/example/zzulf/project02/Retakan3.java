...
public class Retakan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retakan3);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Retakan3.this, Retakan2.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iAdd = new Intent(Retakan3.this, Retakan4.class);
                startActivity(iAdd);
            }
        });
        ...
        cbNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Retakan3.this, Retakan4.class);
    ...
    public void goHome(View view){
        ...
        startActivity(new Intent(Retakan3.this, InputDataJalan.class));
