...
public class JalurPejalanKaki extends AppCompatActivity {
    ...
    void CheckBoxGetter(){
        ...
        Log.d("Hasil","Jalur Pejalan kaki Dipilih :"+ opt1 + ", "+opt2 + ", "+opt3 + ", "+opt4 + ", "+opt5 + ", "+opt6 + ". ");

    }
    void PushData(){
        SharedPreferences JalurPejalanKaki = this.getSharedPreferences("JalurPejalanKaki",MODE_PRIVATE);
        final SharedPreferences.Editor Editor = JalurPejalanKaki.edit();
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cbx_opt1.isChecked() || cbx_opt2.isChecked() || cbx_opt3.isChecked() || cbx_opt4.isChecked() || cbx_opt5.isChecked() || cbx_opt6.isChecked() || cbx_opt7.isChecked() || cbx_opt8.isChecked()  ){
                    ...
                    Toast.makeText(JalurPejalanKaki.this,"Belum ada data yang dipilih",Toast.LENGTH_LONG);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jalur_pejalan_kaki);
    ...
    public void goHome(View view){
        startActivity(new Intent(JalurPejalanKaki.this, InputDataJalan.class));
    }
}
