...
public class Tambalan5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tambalan5);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack = new Intent(Tambalan5.this, Tambalan4.class);
        ...
        cbFinish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Tambalan5.this, InputDataJalan.class);
                startActivity(iNext);
            }
        });
