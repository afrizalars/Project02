...
public class Amblas3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amblas3);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Amblas3.this, Amblas2.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Amblas3.this, Amblas4.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(Amblas3.this, InputDataJalan.class));
    }
    ...
    public void onBackPressed()
    {
        ...
        startActivity(new Intent(Amblas3.this,Amblas2.class));
    }
