...
public class Lubang4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lubang4);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Lubang4.this, Lubang3.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Lubang4.this, Lubang5.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(Lubang4.this, InputDataJalan.class));
    }
}
