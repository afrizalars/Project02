...
public class Amblas2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amblas2);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Amblas2.this, Amblas1.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Amblas2.this, Amblas3.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(Amblas2.this, InputDataJalan.class));
    }
    ...
    public void onBackPressed()
    {
        ...
        startActivity(new Intent(Amblas2.this,Amblas1.class));
    }
