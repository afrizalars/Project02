...
public class RegisterScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayName = findViewById(R.id.et_username);
        mEmail = findViewById(R.id.et_email);
        mPassword = findViewById(R.id.et_password);
        mCreateBtn = findViewById(R.id.btn_Submit);
        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String password = mPassword.getText().toString().trim();
                    ...
                    mProgress.setTitle("Sedang Mendaftarkan User");
                    mProgress.setMessage("Silahkan menunggu selagi akun dibuat...");
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            mDatabase.setValue(userMap).addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    mProgress.dismiss();
                                    Intent mainIntent = new Intent(RegisterScreen.this, LoginScreen.class);
