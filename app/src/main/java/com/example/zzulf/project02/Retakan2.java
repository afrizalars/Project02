...
public class Retakan2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retakan2);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Retakan2.this, Retakan1.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iAdd = new Intent(Retakan2.this, Retakan3.class);
                startActivity(iAdd);
            }
        });
        ...
        cbNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Retakan2.this, Retakan3.class);
    ...
    public void goHome(View view){
        startActivity(new Intent(Retakan2.this, InputDataJalan.class));
    }
}
