...
public class Alur3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alur3);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(Alur3.this, Alur2.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(Alur3.this, Alur4.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(Alur3.this, InputDataJalan.class));
    }
    ...
    public void onBackPressed()
    {
        ...
        startActivity(new Intent(Alur3.this,Alur2.class));
    }
