...
public class KekerasanPermukaan3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kekerasan_permukaan3);
        ...
        cbBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iBack =new Intent(KekerasanPermukaan3.this, KekerasanPermukaan2.class);
        ...
        cbAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent iNext = new Intent(KekerasanPermukaan3.this, KekerasanPermukaan4.class);
                startActivity(iNext);
            }
        });
    ...
    public void goHome(View view){
        startActivity(new Intent(KekerasanPermukaan3.this, InputDataJalan.class));
    }
}
